...
describe.skip('Positive Check : Register=> Success', function () {
    ...
    it('Case 01: register => Success', (done) => {
        try {
            setTimeout(() => {//Wait syncTimeAPI*1000 seconds
                ApiReq.register(API_Env.get().headerSet,{
                    "firstName": "auto",
                    "lastName": "test",
                    "email": "joshua.yu+200@wowow.io",
                    "password": "123456",
                    "phone": "",
                    "userName": ""
