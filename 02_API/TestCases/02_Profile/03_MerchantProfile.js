...
describe('Positive Check : Merchant profile=> Success', function () {
    ...
    it('Case 01: Merchant profile => Success', (done) => {
        try {
            setTimeout(() => {//Wait syncTimeAPI*1000 seconds
                ApiReq.merchantProfileGet(API_Env.get().headerSet,(res, url, header, bodyObject) => {
