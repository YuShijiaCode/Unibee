...
describe.skip('Positive Check :Generate New Api Key=> Success', function () {
    ...
    it('Case 01: Generate New Api Key= => Success', (done) => {
        try {
            setTimeout(() => {//Wait syncTimeAPI*1000 seconds
                ApiReq.newAPIKey(API_Env.get().headerSet,(res, url, header, bodyObject) => {
                    ...
                    // expect(resBody.data.merchant.phone).to.equal(15671);
